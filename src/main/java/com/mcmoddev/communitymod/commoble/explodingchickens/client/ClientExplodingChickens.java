...
@SubMod(modid = "explodingchickensclient", name = "Exploding Chickens Client", description = "Like chickens but louder and on the client", attribution = "Commoble", clientSideOnly = true)
